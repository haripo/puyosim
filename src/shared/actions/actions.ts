...
export const SAVE_CONFIG_COMPLETED = 'SAVE_CONFIG_COMPLETED';
...
export const reconstructHistory = makeActionCreator(RECONSTRUCT_HISTORY, 'history', 'queue', 'index', 'reset');
...
export const saveConfigCompleted = makeActionCreator(SAVE_CONFIG_COMPLETED, 'config');
export const loadConfig = makeActionCreator(LOAD_CONFIG);
export const loadConfigCompleted = makeActionCreator(LOAD_CONFIG_COMPLETED, 'config');
